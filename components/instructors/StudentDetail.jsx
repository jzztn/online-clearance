		...
		<div className="border-[1px] grid grid-cols-[1fr,auto] items-center px-5 rounded-md">
			...
			<div className="relative flex gap-3 items-center">
				...
				<div className="group">
					...
					<div className={`bg-gradient-to-b from-violet to-pink text-white grid text-center absolute bottom-[-46px] left-0 w-28 laptop:w-32 py-3 px-5 rounded-bl-md rounded-br-md rounded-tr-md ${clickArrow ? 'block' : 'hidden'}`}>
						<h1>Cleared</h1>
					</div>
				</div>
			</div>
