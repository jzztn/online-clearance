		...
		<div className="h-screen relative bg-gradient-to-b from-pink to-violet grid grid-rows-[auto,1fr,auto] gap-10 laptop:overflow-hidden">
			...
			<div className="grid items-center tablet:justify-center  text-center px-4">
				<div className="flex flex-col gap-4 laptop:ml-[60%]">
					...
					<Link href={'/instructors/home'}><button className="bg-gradient-to-b from-pink to-violet py-3 laptop:w-96 laptop:py-4 text-white tracking-wide font-semibold drop-shadow-lg rounded-full cursor-pointer tablet:mt-4 hover:scale-105 transition-all duration-500">LOG IN</button></Link>
