			...
			<div className="relative max-w-5xl mx-auto h-screen grid grid-rows-[auto,1fr,auto] gap-10 lg:grid-rows-[auto,1fr] lg:gap-0">
				...
				<div className="grid items-center md:justify-center text-center px-4 lg:grid-cols-[1fr,1fr] lg:items-center lg:px-14">
					...
					<div className="flex flex-col gap-4 ">
						...
						<Link href={'/students/home'}><button className="bg-gradient-to-b from-pink to-violet py-3 w-full laptop:py-4 text-white tracking-wide font-semibold drop-shadow-lg rounded-full cursor-pointer tablet:mt-4 hover:scale-105 transition-all duration-500">LOG IN</button></Link>
